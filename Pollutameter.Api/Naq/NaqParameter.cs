...
public static class NaqParameterFrequency
{
    ...
    public static readonly IReadOnlySet<string> AllFrequencies = new HashSet<string>([AverageForHour, AverageFor24H]);
}
...
public static class NaqParameterCode
{
    ...
    public static readonly IReadOnlySet<string> AllCodes = new HashSet<string>([Pm25, Pm10]);
}
